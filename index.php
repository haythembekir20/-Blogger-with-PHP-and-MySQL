...
$email1=$_POST['email'];
$pass = $_POST['password'];
$sql = "SELECT * FROM user WHERE email = '$email1' and pwd = '$pass'";
...
else if(($count == 1) and ($data['active'] == 0) and ($data['role']==1)){
...
<!-- Mirrored from reditory.gbjsolution.com/login/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 19:56:23 GMT -->
            ...
            <div class="subscription-inner text-center">
                ...
                <form class="subscribe-form"  method="POST" >
                    ...
                    <div class="form-field-wrap field-group-inline">
                        ...
                        <input data-members-email type="email" class="email form-field" id="email" name="email"  placeholder="Your email address" required >
                            </div>
                        <div class="row">
                            <label for="Password" class="sr-only">Password</label>
                            <input data-members-email type="text" class="email form-field" id="password" name="password" placeholder="Your Password" required >
                            </div>
                        <button class="btn form-field" type="submit" name="submit">login </button>
                        </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="alternate-option">
                            <small>Did you Forgot your  <a href="passwordforgot.php">Password ?</a></small>
