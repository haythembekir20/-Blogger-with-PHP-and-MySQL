...
if (isset($_POST['reg_user'])) {
    ...
    if (empty($error_message)) {
        ...
        $query = "INSERT INTO user (email, username, pwd,role,active) 
  			  VALUES('$email1', '$username', '$password_1','0','')";
...
<head>
    ...
    <script defer src="../../unpkg.com/%40tryghost/portal%400.14.0/umd/portal.min.js" data-ghost="../index.html"></script>
    <style type='text/css'>
...
<body class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="subscription-inner text-center">
                        ...
                        <form class="subscribe-form" name="f" method="POST">
                            ...
                            <div class="text-center">
                                <div class="alternate-option">
                                    <small>Do you Wanna be a journalist ? <a href="signup_journalist.php">Sign Up</a></small>
                                </div>
                                <div class="alternate-option">
    ...
    <div class="switch-mode" id="panel">
        <span class="panel-icon" id="show_icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <span class="option dark" id="o-dark"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g data-name="Layer 2">
                    <g data-name="moon">
        ...
        <span class="option light" id="o-light"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g data-name="Layer 2">
                    <g data-name="sun">
