...
<script>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="subscription-inner text-center">
                ...
                <form class="subscribe-form"  method="POST" action="action/actionupdatetopic.php">
                    <div class="text-center">
                    </div>
                    <div class="form-field-wrap field-group-inline">
                        <div class="container">
                            <div class="row">
                        <label for="email" class="sr-only">Titre</label>
                        <input data-members-email type="text" class="email form-field" id="titre" name="titre" value="<?php echo $titre; ?>"  placeholder="Your Titre" >
                            </div>
  ...
  <textarea class="form-control" rows="8"  id="description" name="description" placeholder="description" ><?php echo $description ; ?></textarea>
</div>
                        <button class="btn form-field" name="edit" type="submit">Edit </button>
                        </div>
