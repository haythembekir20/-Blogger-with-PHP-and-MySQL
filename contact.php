...
<!-- Mirrored from reditory.gbjsolution.com/contact/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 19:56:22 GMT -->
    ...
    <script type="application/ld+json">
{
    ...
    "headline": "Contact",
    "url": "http://reditory.gbjsolution.com/contact/",
    "datePublished": "2018-12-08T09:27:00.000Z",
    "dateModified": "2020-06-29T17:14:34.000Z",
    "description": "Do you have any query or just want to say hi?\nSend message using below form, We will get back to you as soon as possible.",
    "mainEntityOfPage": {
        "@type": "WebPage",
	...
	<body class="page-template page-contact">
        ...
        <div class="container">
                    <div class="post-content">
                        <h3 id="do-you-have-any-query-or-just-want-to-say-hi">Do you have any query or just want to say hi?</h3><p>Send message using below form, We will get back to you as soon as possible.</p><!--kg-card-begin: html--><form action="https://formspree.io/your@email.com" method="POST">
    <input type="text" name="name" placeholder="Full name" autocomplete="off">
    <input type="email" name="_replyto" placeholder="Email">
    <input type="text" name="subject" placeholder="Subject">
    <textarea name="message" placeholder="Message" rows="4"></textarea>
    <input type="hidden" name="_subject" id="email-subject" value="Contact Form Submission">
    <input class="btn" type="submit" value="Send Message" rows="8">
