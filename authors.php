...
<!-- Mirrored from reditory.gbjsolution.com/authors/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 19:54:20 GMT -->
    ...
    <script type="application/ld+json">
{
    ...
    "headline": "Authors",
    "url": "http://reditory.gbjsolution.com/authors/",
    "datePublished": "2019-10-20T12:35:16.000Z",
    "dateModified": "2020-06-25T14:42:40.000Z",
    "mainEntityOfPage": {
        "@type": "WebPage",
        ...
        <div class="col-md-8">
            <main class="main-content-area">
                ...
                <?php 
                   ...
                   $req="select * from user where role='1' ";
                        ...
                        <div class="author-archive-card">
                            <div class="item-card-inner text-center">
                                ...
                                <div class="author-info">
                                    <div class="author-name h3"><?php echo $r['username']; ?></div>
                                    <?php 
                                    $user=$r['username'];
                                    $req1="select * from topic where journlist='$user'";
                                    $res2=mysqli_query($cx,$req1);
                                    $count=mysqli_num_rows($res2);
                                    ?>
                                    <div class="post-count"><?php echo $count ; ?> Articles</div>
                                    <div class="bio"> <?php echo $r['bio']; ?> </div>
                                </div>
                            </div>
                        </div>
                    </div>
