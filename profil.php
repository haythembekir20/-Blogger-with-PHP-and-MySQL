...
if (isset($_POST['add'])) {
$bio=$_POST['bio'];
$query = "UPDATE user SET bio='$bio' where username='$email' ";
...
Complete Your Bio if You want it 
                    </div>
                    <div class="form-field-wrap field-group-inline">
                        <div class="container">
                        <div class="form-group">
  
  <textarea class="form-control" rows="8"  id="bio" name="bio" placeholder="Bio " ></textarea>
</div>
                        
                        <button class="btn form-field" name="add" type="submit">Add bio </button>
                        </div>
