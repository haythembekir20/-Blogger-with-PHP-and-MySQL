...
<script>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="subscription-inner text-center">
                ...
                <form class="subscribe-form"  method="POST" enctype="multipart/form-data" action="action/actionaddtopic.php">
                    ...
                    <div class="form-field-wrap field-group-inline">
                        ...
                        <input data-members-email type="text" class="email form-field" id="titre" name="titre"  placeholder="Your Titre" required >
                            </div>
                        <div class="row">
  ...
  <textarea class="form-control" rows="8"  id="description" name="description" placeholder="description" required ></textarea>
</div>
                        
                        <button class="btn form-field" name="add" type="submit">Add </button>
                        </div>
