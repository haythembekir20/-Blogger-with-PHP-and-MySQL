...
<!-- Mirrored from reditory.gbjsolution.com/tag/health/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 19:55:32 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0 shrink-to-fit=no">
        <meta http-equiv="X-UA-Compatible" content="ie=edge">
		<title>Health - Reditory</title>
        <link href="https://fonts.googleapis.com/css2?family=Muli:ital,wght@0,400;1,700&amp;family=Roboto:wght@400;700&amp;display=swap" rel="stylesheet">
		<link href="assets/css/screen.mincc76.css?v=63bbb907b5" rel="stylesheet">
		<meta name="description" content="Quisque feugiat eros sit amet arcu tristique sodales. Suspendisse potenti." />
    ...
    <meta property="og:title" content="Health - Reditory" />
    <meta property="og:description" content="Quisque feugiat eros sit amet arcu tristique sodales. Suspendisse potenti." />
    <meta property="og:url" content="index.html" />
    <meta property="og:image" content="../../content/images/2020/06/christopher-boswell-GEzNsJarkGU-unsplash.jpg" />
    <meta property="article:publisher" content="https://www.facebook.com/gbjsolution" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Health - Reditory" />
    <meta name="twitter:description" content="Quisque feugiat eros sit amet arcu tristique sodales. Suspendisse potenti." />
    <meta name="twitter:url" content="index.html" />
    <meta name="twitter:image" content="../../content/images/2020/06/christopher-boswell-GEzNsJarkGU-unsplash.jpg" />
    ...
    <script type="application/ld+json">
{
    ...
    "url": "http://reditory.gbjsolution.com/tag/health/",
    "image": {
        "@type": "ImageObject",
        "url": "http://reditory.gbjsolution.com/content/images/2020/06/christopher-boswell-GEzNsJarkGU-unsplash.jpg",
        "width": 1000,
        "height": 883
    },
    "name": "Health",
    ...
    "description": "Quisque feugiat eros sit amet arcu tristique sodales. Suspendisse potenti."
}
    </script>
...
<script>
            ...
            <div class="col-md-8">
                <div class="cover-wrap cover-tag">
                    <div class="archive-cover has-image">
                        <img class="lazy feature-image"
                            data-srcset="/content/images/size/w300/2020/06/christopher-boswell-GEzNsJarkGU-unsplash.jpg 300w,
                                    /content/images/size/w600/2020/06/christopher-boswell-GEzNsJarkGU-unsplash.jpg 600w,
                                    /content/images/size/w1000/2020/06/christopher-boswell-GEzNsJarkGU-unsplash.jpg 1000w,
                                    /content/images/size/w1600/2020/06/christopher-boswell-GEzNsJarkGU-unsplash.jpg 1600w"
                            data-sizes="(max-width: 600px) 600px, (max-width: 1160px) 1000px, 1140px"
                            data-src="../../content/images/size/w1000/2020/06/christopher-boswell-GEzNsJarkGU-unsplash.jpg"
                            alt=""
                        />
                        <div class="cover-content-wrapper text-center tc-health">
                            <h1 class="tag-name h2">Health</h1>
                            <div class="tag-description">
                                Quisque feugiat eros sit amet arcu tristique sodales. Suspendisse potenti.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <?php 
                   ...
                   $req="select * from topic where genre='health' ";
    ...
    <div class="col-md-6 col-sm-6 post-list-item">
        <article class="post">
            <a href="post.php?id=<?php echo $r['id'];?>" aria-label="New tech innovation for low cost ocean cleanup">
                <div class="cover-wrap cover-tag">
            ...
            <div class="post-content">
                <div class="tag-wrap">
                    <a href="#" class="tag tag-pill tc-health"><?php echo $r['genre']; ?></a>
                </div>
                <h2 class="post-title h3"><a href="post.php?id=<?php echo $r['id'];?>"><?php echo $r['titre']; ?></a></h2>
                <div class="post-meta">
                    <time class="pub-date" datetime="2020-05-21"><?php echo $r['date']; ?></time>
...
<div class="row justify-center">
    <span class="post-loading-indicator" id="js-post-loding-indicator"></span>
</div>                
            </div>
            <div class="col-md-4">
...
<!-- Mirrored from reditory.gbjsolution.com/tag/health/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 19:55:49 GMT -->
</html>