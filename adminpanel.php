        ...
        <div class="col-md-12">
            <div class="subscription-inner text-center">
                ...
                <form class="subscribe-form"  method="POST" action="action/actionaddtopic.php">
                    ...
                    <h1 class="subscription-title">Manage Journalist!</h1>
                    </div>
                   <table>
                   <thead>
                   ...
                   $req="select * from user where role='1' and active='0' ";
                   ...
                   ?>
                    ...
                    <td> <a href='action/Show_managejournaliste.php?id=<?php echo $r['id'];?>'> <button type="button" class="btn btn-secondary">Show</button> </a>  </td>
                    <td> <a href='action/Delete_managejournaliste.php?id=<?php echo $r['id'];?>'> <button type="button" class="btn btn-danger">Delete</button> </a> </td>
                    <td> <a href='action/Accepte_managejournaliste.php?id=<?php echo $r['id'];?>'> <button type="button" class="btn btn-success">Accepte</button> </a> </td>
